                ...
                <div class="card-body">
                    <form method="POST" action="{{route('ticket.edit', ['id' => $ticket->id])}}" class="mt-3">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="description" type="text" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" value="{{ $ticket->description }}" required autofocus>
                        ...
                        <div class="form-group row">
                            <label for="category" class="col-sm-4 col-form-label text-md-right">Categoría</label>
                                <select name="category_id" class="form-select form-select-lg mb-1 ml-3" aria-label=".form-select-lg example" value="{{ $ticket->categories->name }}">
                                    @if(!empty($categories))
